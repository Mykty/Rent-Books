...
//        setRecScrollPos();
    ...
    public void sortDialog(){
        ...
        LinearLayout filter_period = sortDialogView.findViewById(R.id.filter_period);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.filter_period:

//                Collections.sort(userList, User.userSortPeriod);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.login_page:
                ...
                Intent t = new Intent(getActivity(), AuthenPage.class);
                startActivity(t);
