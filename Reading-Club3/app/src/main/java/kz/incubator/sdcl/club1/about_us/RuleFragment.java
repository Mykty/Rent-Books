            ...
            public View setViewForPosition(int position) {
                ...
                switch (position){
                    case 0:
                        ...
                        price.setText("0 KZT");
                        textDesc.setText("If you give 1 book(bestseller) to Reading Club, we will give you gift 1 month subscription free.");
                    ...
                    case 1:
                        ...
                        textDesc.setText("Our 1 monthly plan grants access to all features of Reading Club for 1 Month.");
                    ...
                    case 2:
                        ...
                        textDesc.setText("Our 2 monthly plan grants access to all features of Reading Club for 2 Month.");
                        textDesc.setTextColor(Color.GRAY);
                        setResideMenuEnabled(false);
                        break;
                    case 3:
                        ...
                        textDesc.setText("Our 3 monthly plan grants access to all features of Reading Club for 3 Month.");
                        setResideMenuEnabled(false);
                        break;
                    case 4:
                        ...
                        textDesc.setText("Our 6 monthly plan grants access to all features of Reading Club for 6 Month.");
                        setResideMenuEnabled(false);
                        break;
                    case 5:
                        ...
                        textDesc.setText("Our 1 year plan grants access to all features of Reading Club for 1 year.");
                        setResideMenuEnabled(false);
                        break;
                }
                return customView;
