...
*/
    ...
    public void saveBookChanges(){
        ...
        Book b = new Book(bId, bName, bAuthor, bDesc, bPNumber, bRating, bCount, book.getPhoto(), bReserved, book_qr_code, imgStorageName);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (downloadUri != null) {
                                ...
                                Book b = new Book(bId, bName, bAuthor, bDesc, bPNumber, bRating, bCount, downloadUri, bReserved, book_qr_code, imgStorageName);
