...
public class LoadingBooksAsyncTask extends AsyncTask<Void, Book, Void> {
    ...
    public LoadingBooksAsyncTask(Context context, RecyclerView recyclerView, SwipeRefreshLayout refreshLayout, String version) {
